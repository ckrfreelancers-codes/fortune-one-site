      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <motion.div
            ...
            className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-orange-400/20 rounded-full blur-3xl"
          />
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              Build your career with Premium Estates and be part of a team that's shaping the future of luxury real estate. We offer growth, innovation, and the opportunity to make a real impact.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {openings.map((job, index) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform perspective-1000"
              >
                <div className="mb-4">
