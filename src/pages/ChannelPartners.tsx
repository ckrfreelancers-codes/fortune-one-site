...
const ChannelPartners = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-[#997E67] via-[#664930] to-[#997E67] text-[#FFDBBB] text-center relative overflow-hidden">
        <motion.div
        ...
        >
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed text-[#CCBEB1]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, i) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-[#FFDBBB]/40 to-[#CCBEB1]/30 p-8 rounded-2xl shadow-lg transition-transform duration-300"
              >
                <div className="w-16 h-16 bg-gradient-to-br from-[#664930] to-[#997E67] rounded-2xl flex items-center justify-center mb-6">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-[#997E67] via-[#664930] to-[#997E67] text-[#FFDBBB] text-center">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Partner With Fortune One?</h2>
